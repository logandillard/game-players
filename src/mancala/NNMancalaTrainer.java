...
import games.ModelBlewUpException;
import games.Move;
import games.NNPlayerTrainer;
...
public class NNMancalaTrainer  {
	...
	public static void main(String[] args) throws Exception {
		NNPlayerTrainer<Mancala> trainer = new NNPlayerTrainer<Mancala>();
		boolean cont = true;
		...
		GamePlayer<Mancala> randPlayer = new RandomPlayer();
		GamePlayer<Mancala> abPruning1 = new ABPruningPlayer(1);
		GamePlayer<Mancala> abPruning2 = new ABPruningPlayer(2);
		GamePlayer<Mancala> abPruning3 = new ABPruningPlayer(3);
		GamePlayer<Mancala> abPruning4 = new ABPruningPlayer(4);
		
		// Set benchmarking players (opponents)
		GamePlayer<Mancala>[] benchOpponents = new GamePlayer[] {abPruning2, abPruning1}; //, abPruning1, randPlayer 
		String[] benchOpponentsNames = new String[] {"AB-2", "AB-1"}; //"AB-4", "AB-3",, "AB-1", "Rand"

		// Set the training opponents
		GamePlayer<Mancala>[] trainOpponents = new GamePlayer[] {nnPlayer}; 
